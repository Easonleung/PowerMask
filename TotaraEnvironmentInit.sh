...
echo "$rootpassword" | sudo apt-get install php7.4-{bcmath,bz2,curl,intl,gd,mbstring,mysql,zip,fpm,xmlrpc} -y
...
echo "$rootpassword" | sudo cp PowerMask/phpinfo.php /var/www/html/totara15/phpinfo.php
echo "$rootpassword" | sudo cp PowerMask/phpinfo.php /var/www/html/totara13/phpinfo.php
echo ""
